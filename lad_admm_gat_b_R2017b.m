function [ x,r,d,rho,Rhov,res_pv,res_dv,cost_val ] = lad_admm_gat_b_R2017b( A,y,varargin )
% [ x,r,d,rho,Rhov,res_pv,res_dv,cost_val ] =lad_admm_gat_b_R2017b( A,y,varargin)
...
% diverged from lad_admm_gat_b.m of the version 97df9ca
%
% INPUT Parameters
