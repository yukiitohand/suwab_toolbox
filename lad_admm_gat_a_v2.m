function [ x,r,d,rho,Rhov,res_pv,res_dv,cost_val ] = lad_admm_gat_a_v2( A,y,varargin )
% [ x,r,d,rho,Rhov,res_pv,res_dv,cost_val ] = lad_admm_gat_a_v2( A,y,varargin )
%   perform least absolute deviation using a alternating 
%   direction method of multipliers (ADMM) with a generalized augmentation
%   term.
%     Input Parameters
